package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_722:Number = 64;
      ...
      private var var_399:Number = 1.0;
      
      private var var_398:Number = 1.0;
      ...
      private var var_2485:Number = 500.0;
      
      private var var_1501:Number = 1.0;
      
      private var var_83:Vector3d;
      
      private var var_84:Vector3d;
      
      private var var_2486:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         x_scale = 1;
         y_scale = 1;
         var_1499 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_224.assign(param1);
         if(var_224.x != _loc2_ || var_224.y != _loc3_ || var_224.z != _loc4_)
         {
            ++var_77;
         }
      ...
      {
         if(var_398 != param1 * var_1499)
         {
            var_398 = param1 * var_1499;
            ++var_77;
         }
      }
      ...
      {
         if(var_399 != param1 * var_1500)
         {
            var_399 = param1 * var_1500;
            ++var_77;
         }
      }
      ...
      {
         if(var_400 != param1 * var_1501)
         {
            var_400 = param1 * var_1501;
            ++var_77;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_401 != null)
         {
            ...
            var_401.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_401.add(_loc3_,_loc4_);
            ++var_77;
         }
      }
      ...
      {
         return new Vector3d(var_224.x,var_224.y,var_224.z);
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         if(_loc3_ < var_2486 || _loc3_ > var_2485)
         {
            return null;
         }
      ...
      {
         return new Vector3d(0 * var_399,0 * var_400,0 * var_398);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_401 != null)
         {
            ...
            return var_401.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_399,0 * var_400,0 * var_398);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_84;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_399,param2.y * var_400,param2.z * var_398);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_399,param3.y * var_400,param3.z * var_398);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_399,param4.y * var_400,param4.z * var_398);
