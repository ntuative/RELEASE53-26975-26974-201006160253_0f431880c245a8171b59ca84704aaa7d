package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_1933:IContainerButtonWindow;
      
      private var var_1932:IContainerButtonWindow;
      
      private var var_1931:IContainerButtonWindow;
      
      private var var_1930:IContainerButtonWindow;
      
      private var var_352:AvatarPopupCtrl;
      ...
      {
         _friendList = param1;
         var_352 = new AvatarPopupCtrl(_friendList);
      }
      ...
      {
         var_1932 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1931 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1933 = initButton("room_invite",onInviteButtonClick,param1);
         var_1930 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_352.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_352.showPopup(_friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_33)
         {
            this.var_352.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_261)
         {
            _loc4_ = _friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            refreshButtons();
            refreshList();
            if(param1.type == WindowMouseEvent.const_261 && _loc4_.online)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1932,isEnableMinimailButton(_loc1_));
         setEnabled(var_1931,isEnableHomeButton(_loc1_));
         setEnabled(var_1933,isEnableInviteButton(_loc1_));
         setEnabled(var_1930,isEnableRemoveButton(_loc1_));
      }
