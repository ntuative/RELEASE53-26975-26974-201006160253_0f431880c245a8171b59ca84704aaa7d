package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_541:Timer;
      
      private var var_146:IHabboConfigurationManager;
      
      private var var_1647:OpenedToWebPopup;
      
      private var var_954:IAvatarRenderManager;
      ...
      private var var_1648:AvatarSearchResults;
      ...
      private var var_2170:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_955:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2170 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_93 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1648 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            var_429.findTab(FriendListTab.const_90).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_93.addCategory(new FriendCategory(FriendCategory.const_975,getText("friendlist.friends")));
         var_93.addCategory(new FriendCategory(FriendCategory.const_502,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_93.addFriend(new Friend(_loc4_));
         }
         var_429 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_541)
         {
            var_541 = new Timer(120000);
            var_541.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_541.start();
         }
         getBuddyRequests();
         registerListeners();
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_541.stop();
            var_541.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_541 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_124)
         {
            var_124.release(new IIDHabboMessenger());
            var_124 = null;
         }
         if(var_146)
         {
         ...
         if(var_954)
         {
            var_954.release(new IIDAvatarRenderManager());
            var_954 = null;
         }
         if(var_955)
         {
            var_955.release(new IIDHabboNotifications());
            var_955 = null;
         }
         if(_toolbar)
         {
         ...
         if(var_648)
         {
            var_648.release(new IIDSessionDataManager());
            var_648 = null;
         }
         super.dispose();
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_124 = param2 as IHabboMessenger;
      ...
      {
         var _loc1_:String = var_146.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_429.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_360));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1648.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_648.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_648.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
      ...
      {
         var _loc2_:FriendListTab = var_429.findTab(FriendListTab.const_90);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_954.createAvatarImage(param1,AvatarScaleType.SMALL,null,this);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_45);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = var_429.findTab(FriendListTab.const_90);
      ...
      private function registerListeners() : void
      {
         ...
         _communication.addHabboConnectionMessageEvent(new AcceptBuddyResultEvent(method_7));
      ...
      {
         return var_146.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1647 == null)
         {
            var_1647 = new OpenedToWebPopup(this);
         }
         var_1647.show(x,y);
      }
