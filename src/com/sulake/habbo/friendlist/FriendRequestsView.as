package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1478:String = "no_reqs_info";
       
      
      private var var_1661:IContainerButtonWindow;
      
      private var _friendList:HabboFriendList;
      
      private var var_1662:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_355 && _loc4_.state != FriendRequest.const_318)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_355;
      ...
      {
         var_1661 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1662 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1662.procedure = onDismissAllButtonClick;
         var_1661.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_355 && _loc4_.state != FriendRequest.const_318)
            {
               ...
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_265,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = _friendList.laf.getRowShadingColor(FriendListTab.const_90,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_355)
         {
         ...
         else if(param1.state == FriendRequest.const_896)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1661,_loc1_);
         setEnabled(var_1662,_loc1_);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_355;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_265,param1));
         }
      }
   }
}
