package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_308:int = 100;
      ...
      {
         return Math.ceil(this.var_229.length / const_308);
      }
      ...
      {
         if(this.var_851 >= this.getPageCount())
         {
            this.var_851 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         {
            _loc4_ = var_229[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_229.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_851 + 1) * const_308,this.var_229.length);
      }
