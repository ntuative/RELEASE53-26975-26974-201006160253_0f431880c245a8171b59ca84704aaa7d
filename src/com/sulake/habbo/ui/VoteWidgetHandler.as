package com.sulake.habbo.ui
{
   ...
   public class VoteWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionVoteEvent.const_122:
               ...
               break;
            case RoomSessionVoteEvent.const_130:
               _loc3_ = new RoomWidgetVoteUpdateEvent(RoomWidgetVoteUpdateEvent.const_130,_loc2_.question,_loc2_.choices,_loc2_.votes,_loc2_.totalVotes);
         }
         if(_loc3_ == null)
         {
            return;
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetVoteMessage.const_117:
               ...
               _container.roomSession.sendVote(_loc2_.method_3);
               break;
         }
         return null;
      }
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(RoomSessionVoteEvent.const_130);
         return _loc1_;
      }
