package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_703,RoomWidgetEcotronBoxOpenMessage.const_579,RoomWidgetEcotronBoxOpenedMessage.const_1355];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_703:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_579:
