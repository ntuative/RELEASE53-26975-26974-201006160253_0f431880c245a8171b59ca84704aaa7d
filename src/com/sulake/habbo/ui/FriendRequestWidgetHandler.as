package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_657);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_558);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_538);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case FriendRequestEvent.const_265:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_657:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_558:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_538:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(FriendRequestEvent.const_265);
         return _loc1_;
      }
