   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_144,onUserTags);
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_139,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_156,onFigureUpdate);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_154,onPetInfo);
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_144,onUserTags);
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_139,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_156,onFigureUpdate);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_154,onPetInfo);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_729);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_323);
                  ...
                  if(_loc23_ != null)
                  {
                     ...
                     if(false && param1.category == RoomObjectCategoryEnum.const_34)
                     {
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_891);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_835);
            ...
            case RoomObjectCategoryEnum.const_38:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_245)
               {
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_1018)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_478);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_210)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_553);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1424;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1030;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1050;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1256);
               }
               else
               {
               ...
               _loc18_ = _loc11_.sex;
               _loc19_ = _container.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_53,_loc18_);
               if(_loc19_ != null)
               {
                  _loc19_.setDirection(AvatarSetType.const_36,4);
                  _loc13_.image = _loc19_.getImage(AvatarSetType.const_36,true);
                  _loc19_.dispose();
               }
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         if(false)
         {
            _loc5_ = _container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_53,param1.gender);
            if(_loc5_ != null)
            {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_676.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_53);
            var_676.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(_container != null && false)
         {
            ...
            _loc9_ = new RoomWidgetPetInfoUpdateEvent(_loc6_,_loc7_,_loc3_.name,_loc2_.petId,_loc5_.getCroppedImage(AvatarSetType.const_36),_loc8_,_loc2_.ownerId,_loc2_.ownerName,_loc3_.id);
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_553);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_756);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_253);
         _loc1_.push(RoomWidgetFurniActionMessage.const_612);
         _loc1_.push(RoomWidgetFurniActionMessage.const_667);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_732);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_727);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1209);
         _loc1_.push(RoomWidgetPetCommandMessage.const_564);
         _loc1_.push(RoomWidgetPetCommandMessage.const_563);
         _loc1_.push(RoomWidgetUserActionMessage.const_746);
         _loc1_.push(RoomWidgetUserActionMessage.const_444);
         return _loc1_;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_676 != null)
         {
            _loc1_ = var_676.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_676.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_451)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_651:
               ...
               break;
            case RoomWidgetUserActionMessage.const_756:
            ...
            case RoomWidgetUserActionMessage.const_752:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_854,_loc3_.name);
            ...
            case RoomWidgetRoomTagSearchMessage.const_732:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_727:
            ...
            case RoomWidgetPetCommandMessage.const_563:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_564:
