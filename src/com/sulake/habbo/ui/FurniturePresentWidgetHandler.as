package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1109:String = "poster";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_663,RoomWidgetPresentOpenMessage.const_658,RoomWidgetPresentOpenedMessage.const_1286];
      }
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_83:
                           if(_loc3_ != null && _loc3_.name == const_200)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_448,0,_container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == const_87)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_510,0,_container.localization.getKey("inventory.furni.item.landscape.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == const_201)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_376,0,_container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                              if(_loc3_ != null && _loc3_.name == const_1109)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_349:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_479,0,_container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_663:
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_163 = _loc2_.id;
                     _loc6_ = _loc5_.getString(RoomObjectVariableEnum.const_111);
                     if(_loc6_ == null)
                     {
                        _loc6_ = "";
                     }
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_658:
               _loc4_ = param1 as RoomWidgetPresentOpenMessage;
               if(_loc4_.objectId != var_163)
               {
                  return null;
               }
