package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_181:HabboHotelView;
      ...
      private var var_2175:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1650:ILogger;
      
      private var var_1391:String;
      
      private var var_2177:String;
      
      private const const_1459:String = "fuselogin";
      ...
      private var var_59:IHabboCommunicationManager;
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         if(var_1125)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_188);
         }
         var_2176 = true;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2176)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_775 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_775);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_165);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      {
         var_1125 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_240);
         param1.send(new VersionCheckMessageComposer(401,var_1391,var_2177));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1459,"/");
      ...
      {
         var _loc4_:IConnection = var_59.getHabboMainConnection(null);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2175);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1459,"/");
      ...
      {
         var_775 = _habboConfiguration.getKey("sso.ticket",null);
         var_1391 = _habboConfiguration.getKey("flash.client.url","");
         var_2177 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_181 == null)
         {
            var_181 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_775 != null)
         {
            var_59.mode = HabboConnectionType.const_470;
            var_59.initConnection(HabboConnectionType.const_252);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1650 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_59 = param2 as IHabboCommunicationManager;
            _loc3_ = var_59.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_59.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_59.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_59.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_59.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_59.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_59.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_59.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_59.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_59.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_59.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_59.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_59.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
            var_59.addHabboConnectionMessageEvent(new IdentityAccountsEvent(onIdentityAccounts));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_59.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_647);
            _loc3_ = new InitCryptoMessageComposer(var_59.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2175 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_59.mode)
         {
            case HabboConnectionType.const_470:
               _loc6_ = "";
               ...
               var_1126 = _loc4_;
               var_181.loadBannerImage(_loc7_ + "?token=" + var_1126,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_874:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1222:
               var_650 = generateRandomHexString(30);
               var_449 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_449.init(var_650);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_181.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1126);
         ...
         var _loc9_:IConnection = var_59.getHabboMainConnection(null);
         ...
         while(_loc13_ > 0)
         {
            ...
            var_449.init(_loc14_);
            _loc15_ = var_449.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_59.mode = HabboConnectionType.const_874;
            }
         }
         var_59.initConnection(HabboConnectionType.const_252);
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_108,onRoomSessionEnded);
      }
