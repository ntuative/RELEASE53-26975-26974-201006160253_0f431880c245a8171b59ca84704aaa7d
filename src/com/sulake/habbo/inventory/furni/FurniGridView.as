package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      private var var_519:IItemGridWindow;
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(_view != null)
         {
            var_519 = _view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      
      public function updateItem(param1:int, param2:IWindowContainer) : void
      {
         var _loc3_:IWindow = var_519.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            var_519.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var_519.addGridItemAt(param1,param2);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_54)
         {
            ...
            _model.toggleItemSelection(_category,var_519.getGridItemIndex(param1.window));
            var_365 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_33 && var_365 != null && var_365 == param2 && true)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_261)
         {
