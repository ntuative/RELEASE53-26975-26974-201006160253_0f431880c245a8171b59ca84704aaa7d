package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_319:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_542 = new Timer(const_1140,1);
         var_542.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_260;
      }
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc8_:int = 0;
         var _loc6_:Array = [const_44,const_46];
         var _loc7_:int = 0;
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_669)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_542 != null)
            {
               var_542.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_542.stop();
               var_542 = null;
            }
            if(var_143 != null)
            {
               var_143.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_143.stop();
               var_143 = null;
            }
            if(var_777 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_324)
         {
         ...
         else if(param3 == FurniCategory.const_351)
         {
         ...
         if(var_777 == null)
         {
            var_777 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_777.clone() as IWindowContainer;
      ...
      public function removeAllLocks() : void
      {
         ...
         var _loc3_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_44,const_46];
         var _loc6_:int = 0;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_260:
               ...
               break;
            case InventorySubCategory.const_1028:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_143 = new Timer(param1,1);
            var_143.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_143.start();
         }
         else
         {
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_305);
         ...
         if(param1 == InventoryCategory.const_78 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_319:
                  _controller.toggleInventoryPage(InventoryCategory.const_151);
            }
         }
      }
      ...
      public function updateLocks() : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc1_ = _loc1_.concat(_loc3_.method_12());
         }
         if(_loc1_.length == 0)
         {
            removeAllLocks();
         ...
         var _loc8_:Array = [const_44,const_46];
         var _loc9_:int = 0;
      ...
      {
         if(var_959 && param1.type == RoomEngineObjectEvent.const_203)
         {
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_44,const_46];
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_.length)
         {
      ...
      public function removeFurni(param1:int) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = null;
         var _loc7_:Array = [const_44,const_46];
         var _loc8_:int = 0;
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_314 || _loc3_.category == FurniCategory.const_324 || _loc3_.category == FurniCategory.const_351)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_450 = new Map();
         var_450.add(const_44,new Array());
