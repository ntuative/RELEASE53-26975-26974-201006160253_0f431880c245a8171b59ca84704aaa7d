package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_519 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      public function removePet(param1:int) : void
      {
         ...
         var_519.removeGridItem(_loc2_.window);
         if(var_315 == _loc2_)
         {
            var_315 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(_loc2_ != null)
         {
            var_519.addGridItem(_loc2_.window);
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = _avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_53,this);
            if(_loc13_ == null)
            {
               return;
            }
            _loc13_.setDirection(AvatarSetType.const_36,4);
            _loc2_ = _loc13_.getCroppedImage(AvatarSetType.const_36);
            _loc3_ = _loc12_.name;
