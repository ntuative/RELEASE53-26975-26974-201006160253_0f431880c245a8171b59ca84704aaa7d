package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1051:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_605 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_605.width;
         var_94 = var_605.height;
         var_1050 = param5;
         var_860 = param6;
         var_231 = Math.floor(var_1050 / _thumbWidth);
         var_18 = new BitmapData(var_1050,var_860);
      }
      
      public function resolveIndexFromImageLocation(param1:Point) : int
      {
         var _loc2_:Point = resolveGridLocationFromImage(param1);
         return int(_loc2_.y * var_231 + _loc2_.x);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = var_231 - param1.x - 1;
         ...
         if(var_18.height < var_860)
         {
            _loc12_ = new BitmapData(var_18.width,var_860);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_605.width,var_605.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_605.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_605,var_605.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1051 != null)
         {
            _loc1_ = var_1051.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_18 = new BitmapData(Math.max(var_231 * _thumbWidth,var_1050),Math.max(var_498 * var_94,var_860),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_231 && var_18.height < _loc3_.y * var_94)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_231 - 1),var_94);
         _loc2_.copyPixels(var_18,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_231 - 1),0,_thumbWidth,var_18.height);
         _loc2_.copyPixels(var_18,_loc4_,new Point(0,var_94),null,null,true);
         _loc4_ = new Rectangle(0,var_94,_thumbWidth * (var_231 - 1),0 - var_94);
      ...
      {
         var _loc1_:Array = getList();
         return int(Math.ceil(_loc1_.length / var_231));
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / var_231);
         var _loc3_:int = param1 % var_231;
         return new Point(_loc3_,_loc2_);
      }
