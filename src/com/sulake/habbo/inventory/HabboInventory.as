package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_944:IRoomSession;
      ...
      private const const_1746:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_19 != null)
         {
            var_19.events.removeEventListener(RoomSessionEvent.const_95,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionEvent.const_108,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_411,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_108:
               var_944 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_411:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_46.getValue(InventoryCategory.const_549));
      }
      ...
      {
         var_100.clubPeriods = param1;
         var_100.clubDays = param2;
         var_100.clubHasEverBeenMember = param3;
         var_100.isVIP = param4;
      ...
      {
         return PetsModel(var_46.getValue(InventoryCategory.const_151));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_894));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1746);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_46.getValue(InventoryCategory.const_341));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_260:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_945.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_945.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_46.getValue(InventorySubCategory.const_260));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_381 = ISessionDataManager(param2);
      ...
      {
         return var_100.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_46.getValue(InventoryCategory.const_305) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1114 = new IncomingMessages(this);
      ...
      {
         return var_100.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_100.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_46.getValue(InventoryCategory.const_291));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_95,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionEvent.const_108,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_411,roomSessionEventHandler);
         ...
         var_46.add(InventoryCategory.const_305,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_381);
         var_46.add(InventoryCategory.const_291,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_46.add(InventoryCategory.const_549,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_381);
         var_46.add(InventoryCategory.const_341,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_46.add(InventorySubCategory.const_260,_loc8_);
         ...
         var_46.add(InventoryCategory.const_151,_loc10_);
      ...
      public function returnInventoryFurniFromRecycler(param1:int) : Boolean
      {
         if(recyclerModel != null)
         {
            return recyclerModel.method_9(param1);
         }
         return false;
      }
