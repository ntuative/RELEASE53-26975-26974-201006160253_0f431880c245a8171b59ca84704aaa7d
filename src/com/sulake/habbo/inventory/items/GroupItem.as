package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2405:BitmapData;
      ...
      protected var var_392:BitmapData;
      
      private const const_1466:Number = 0.2;
      
      protected var var_1473:Boolean;
      
      private const const_1467:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_669)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1519));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1477);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1466;
               _loc1_.blend = const_1466;
            }
            else
            {
               _window.blend = const_1467;
               _loc1_.blend = const_1467;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1473 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2405;
               _loc5_.visible = true;
            }
            else
            {
