package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1474:uint = 0;
      ...
      private const const_1745:uint = 4.282169599E9;
      ...
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_754)
         {
            return;
         }
         if(var_754 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_754) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_754 % 2) ? uint(const_1474) : uint(const_1475);
            }
         }
         _loc2_ = _itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = const_1745;
            var_754 = param1;
         }
      }
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(const_1474) : uint(const_1475);
