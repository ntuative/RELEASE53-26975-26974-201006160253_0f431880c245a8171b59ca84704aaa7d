package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_905:IWindow;
      
      private var var_907:IWindow;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_907 = _window.findChildByName("effect_hilite");
            var_907.visible = false;
         }
         var_906 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_905 = _window.findChildByName("loader_bar");
         if(var_905 != null)
         {
            var_423 = var_905.width;
            var_174.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_906 != null)
         {
            var_906.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_906.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
