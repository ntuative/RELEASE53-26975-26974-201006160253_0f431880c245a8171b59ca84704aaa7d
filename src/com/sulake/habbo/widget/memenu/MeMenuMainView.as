      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_856);
               break;
            case "wave":
               if(false)
               {
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_615);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1049));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_292);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_992));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_737);
               break;
            case "news":
               if(false && false)
               {
