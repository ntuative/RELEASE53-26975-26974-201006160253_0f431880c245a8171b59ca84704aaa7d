package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_465:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_465 = new Sprite();
            var_465.addChild(new Bitmap(_image));
            var_465.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_465.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_465);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1687 != "")
         {
            HabboWebTools.openWebPage(var_1687);
         }
      }
      ...
      override public function dispose() : void
      {
         if(var_465 != null)
         {
            var_465.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_465 = null;
         }
         if(_image != null)
         {
