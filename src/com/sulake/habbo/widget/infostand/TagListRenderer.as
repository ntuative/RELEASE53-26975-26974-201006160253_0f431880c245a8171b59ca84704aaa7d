package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1739:int = 5;
      
      private const const_1740:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1384 != null && var_1384.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_863 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_863 += param1.height + const_1740;
            return fit(param1);
         }
         param1.offset(_offsetX,var_863);
         _offsetX += param1.width + const_1739;
         return true;
      }
