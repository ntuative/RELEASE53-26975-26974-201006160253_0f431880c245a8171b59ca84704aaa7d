package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_753:Array = null;
      ...
      private var var_1268:int = 30000;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         if(_config != null)
         {
            var_1268 = int(_config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_130,showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_317,update);
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - var_1882;
         if(_loc2_ > var_1268)
         {
            method_3();
            return;
      ...
      private function onChoiceClicked(param1:WindowMouseEvent) : void
      {
         ...
         method_3(param1.window.id);
      }
      
      private function method_3(param1:int = -1) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var_1267 = param1;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_130,showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_317,update);
      }
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((var_1268 - param1) / 1000,0);
