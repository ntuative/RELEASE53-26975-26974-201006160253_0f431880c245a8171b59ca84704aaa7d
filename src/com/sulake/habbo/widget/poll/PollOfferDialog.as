package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_273:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_600:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1324:String = "POLL_OFFER_STATE_OK";
      ...
      private var var_36:String = "POLL_OFFER_STATE_UNKNOWN";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_36 = const_1324;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_668,_id));
                     break;
                  case "poll_offer_button_cancel":
                     var_36 = const_600;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_421,_id));
