package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_796[var_1151] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_331)
         {
            ...
            var_331 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_331.center();
            var_331.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1151;
         if(var_1151 < var_796.length)
         {
            _loc1_ = var_796[var_1151] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_796.length);
                  _loc2_.text = _loc6_;
               }
