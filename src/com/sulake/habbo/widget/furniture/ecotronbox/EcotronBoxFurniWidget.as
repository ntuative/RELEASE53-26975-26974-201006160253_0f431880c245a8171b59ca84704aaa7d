package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_579,var_163);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_56,HabboWindowStyle.const_42,0 | 0,new Rectangle(const_1081,const_1080,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null && var_206 != null)
         {
            _loc6_.caption = var_206;
         }
