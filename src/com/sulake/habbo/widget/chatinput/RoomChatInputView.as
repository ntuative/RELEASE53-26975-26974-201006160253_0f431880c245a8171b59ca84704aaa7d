package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1469:int = 5;
      
      private static const const_528:int = 16;
      
      private static const const_1110:int = 20;
      
      private static const const_374:int = 10;
      
      private static const const_1111:int = 40;
      ...
      private var var_893:Timer;
      
      private var _widget:RoomChatInputWidget;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1995:Number = 0;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1071 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1997 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1996 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_743 = new Timer(1000,1);
         var_743.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_893 = new Timer(5000,1);
         var_893.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_56,HabboWindowStyle.const_41,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_153,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_47,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_140,onInputChanged);
         _window.addEventListener(WindowEvent.const_493,onWindowMoved);
         var_1317 = true;
         var_134 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1995 = _loc2_.width + const_528 + _loc6_.width + const_1110;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1111,_loc8_.width) + const_528);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1071 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_134 = "";
               }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_507);
