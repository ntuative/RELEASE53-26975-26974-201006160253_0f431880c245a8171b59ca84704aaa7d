package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_811:int = 0;
      
      public static const const_193:int = 5;
      
      private static const const_371:int = 1;
      
      private static const const_810:int = 2;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1645)
         {
            case RecyclerStatusMessageEvent.const_1371:
               ...
               break;
            case RecyclerStatusMessageEvent.const_909:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1363:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1645 != RecyclerStatusMessageEvent.const_909;
      }
      
      private function get statusActive() : Boolean
      {
         return var_286 != const_811;
      }
      ...
      {
         return active && var_286 == const_371;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_828:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1319:
