package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1474:uint = 4.294967295E9;
      
      private const const_1475:uint = 4.293848814E9;
      
      private var var_844:int;
      
      private const const_1724:uint = 4.291613146E9;
      ...
      private const const_1723:int = 10;
      ...
      private function checkboxHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_744:
               showSelectors(false);
               break;
            case WindowEvent.const_704:
               showSelectors(true);
         }
      }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1475) : uint(const_1474);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_418,var_76,var_1031);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc9_:int = !!_loc6_ ? 0 : int(var_596[var_195]);
         _catalog.purchaseProductAsGift(var_418,var_76,var_1031,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_140:
               ...
               _loc5_ = [];
               for each(_loc7_ in var_229)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1723)
                  {
                     break;
                  }
               }
            ...
            case WindowMouseEvent.const_54:
               ...
               break;
            case WindowKeyboardEvent.const_631:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_483 == null)
         {
            var_483 = createWindow("suggestion_list_item") as IWindowContainer;
            var_483.procedure = suggestionsEventHandler;
         }
         if(var_227 == null || var_483 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_227.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_483.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
