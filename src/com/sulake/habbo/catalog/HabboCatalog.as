package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_442:ClubBuyController;
      ...
      private var var_119:IMarketPlace;
      ...
      private var var_324:CatalogViewer;
      
      private var var_2144:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_443:ICatalogNavigator;
      ...
      private var var_2145:GiftWrappingConfiguration;
      ...
      private var var_1118:ClubGiftController;
      ...
      {
         return var_381.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_100.credits = _loc3_.balance;
         updatePurse();
         if(!var_2143 && var_533 != null)
         {
            var_533.playSound(HabboSoundTypesEnum.const_889);
         }
         var_2143 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_381.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_83)
         {
            _loc3_ = var_381.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_86 == null)
         {
            return;
         }
         var_86.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_442 == null)
         {
            var_442 = new ClubBuyController(this);
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_95:
               var_1377 = param1.session.isPrivateRoom;
               if(var_86 != null)
               {
                  var_86.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_108:
               ...
               if(var_86 != null)
               {
                  var_86.setRoomSessionActive(false);
               }
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         var_86.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_146.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_146.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2145 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!var_947)
         {
            if(!var_381.loadProductData(this))
            {
               return;
            }
            init();
         ...
         {
            _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
            _events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
            if(var_86 != null && getCurrentLayoutCode() == "recycler")
            {
               var_86.activate();
            }
         }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1118.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      {
         var_86 = new RecyclerLogic(this,_windowManager);
         getRecyclerPrizes();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_443 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_100.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_100.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         var_100.isVIP = _loc2_.isVIP;
         var_100.pastClubDays = _loc2_.pastClubDays;
         var_100.pastVipDays = _loc2_.pastVipDays;
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_1118 == null)
         {
            var_1118 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         {
            var_442.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_119.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function createMarketPlace() : void
      {
         if(var_119 == null)
         {
            var_119 = new MarketPlaceLogic(this,_windowManager,_roomEngine);
         }
      }
      ...
      {
         _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_443.buildCatalogIndex(_loc2_);
         if(var_1117 != "")
         {
            var_443.openPage(var_1117);
            var_1117 = "";
         }
         else
         {
            var_443.openFrontPage();
         }
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_183)
         {
            _loc3_ = var_146.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(param1 == null || var_324 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_324.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         var_86.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_100.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_100.pixels));
         var _loc1_:int = 0;
         if(true)
         {
         ...
         else
         {
            ...
            _localization.registerParameter(_loc2_,"days",String(var_100.clubDays));
            _localization.registerParameter(_loc2_,"months",String(var_100.clubPeriods));
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_324.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_100.pixels = _loc2_.amount;
         updatePurse();
         if(!var_2144 && var_533 != null)
         {
            var_533.playSound(HabboSoundTypesEnum.const_850);
         }
         var_2144 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_324.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_324.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_324 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_324.habboCatalog = this;
      }
