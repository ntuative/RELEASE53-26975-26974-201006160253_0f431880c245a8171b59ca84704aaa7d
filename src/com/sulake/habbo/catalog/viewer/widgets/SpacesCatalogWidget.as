package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_200:String = "floor";
      
      private static const const_201:String = "wallpaper";
       
      
      private var var_1433:String = "default";
      ...
      override public function init() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               {
                  case "floor":
                     for each(_loc9_ in var_146.floors.pattern)
                     {
                     ...
                     break;
                  case "wallpaper":
                     for each(_loc10_ in var_146.walls.pattern)
                     {
                     ...
                     break;
                  case "landscape":
                     for each(_loc11_ in var_146.landscapes.pattern)
                     {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_270 != null && var_271 != null)
         {
            setRoomImage(var_270,var_271);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_146.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_234 >= 0)
         ...
         for each(_loc1_ in var_146.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
         ...
         for each(_loc1_ in var_146.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[var_273];
               if(_loc13_ != null)
               {
                  var_1432 = _loc13_.@id;
               }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_201:
               ...
               var_737 = 0;
               _loc5_ = "null";
               for each(_loc8_ in var_146.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_737 = _loc8_.children().length();
                  }
               }
            ...
            case const_200:
               ...
               if(var_312 >= _activeFloorPatterns.length)
               {
                  var_312 = 0;
               }
               var_272 = 0;
               ...
               for each(_loc9_ in var_146.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_736 = _loc9_.children().length();
                  }
               }
            ...
            case const_87:
               ...
               var_738 = 0;
               _loc7_ = "null";
               for each(_loc10_ in var_146.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_738 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1433);
               }
               break;
            case "ctlg_floor_pattern_prev":
               changePattern(const_200,-1);
               break;
            case "ctlg_floor_pattern_next":
               changePattern(const_200,1);
               break;
            case "ctlg_floor_color_prev":
               changeColor(const_200,-1);
               break;
            case "ctlg_floor_color_next":
               changeColor(const_200,1);
               break;
            case "ctlg_buy_floor":
               _loc3_ = var_1299[var_312];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1296[var_311];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1432);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1433,var_1432,64,this,"window_romantic_wide");
