package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private const const_159:int = 31;
      ...
      private function updateList() : void
      {
         ...
         for each(_loc6_ in _loc2_)
         {
            ...
            if(_loc5_)
            {
               ...
               var_602.add(_loc1_.offerId,_loc1_);
            }
         }
      }
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!var_196)
         {
            var_196 = createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!var_196)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = var_196.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         var_196.setGlobalPosition(_loc6_.subtract(new Point(0,0)));
         var_196.visible = true;
         var_196.activate();
      }
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc5_)
         {
            _loc2_ = _controller.purse.pastClubDays > const_159 ? "catalog.club_gift.past_club.long" : "catalog.club_gift.past_club";
            _loc3_ = _controller.purse.pastClubDays % const_159;
            _loc4_ = _controller.purse.pastClubDays / const_159;
         ...
         if(_loc6_)
         {
            _loc2_ = _controller.purse.pastVipDays > const_159 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = _controller.purse.pastVipDays % const_159;
            _loc4_ = _controller.purse.pastVipDays / const_159;
            _controller.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            _controller.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      {
         if(!param1 || !param2 || !var_602 || !_controller)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_602.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         {
            _loc11_ = param2.monthsRequired * const_159;
            if(param2.isVip)
            {
               _loc12_ = _loc11_ - _controller.purse.pastVipDays;
               _loc6_ = "catalog.club_gift.vip_missing";
            }
            else
            {
               _loc12_ = _loc11_ - _controller.purse.pastClubDays;
               _loc6_ = "catalog.club_gift.club_missing";
            }
            if(_loc12_ >= const_159)
            {
               _loc6_ += ".long";
            }
            if(_loc12_ <= 0)
            ...
            {
               _loc13_ = _loc12_ % const_159;
               _loc14_ = _loc12_ / const_159;
               _controller.localization.registerParameter(_loc6_,"days",_loc13_.toString());
               _controller.localization.registerParameter(_loc6_,"months",_loc14_.toString());
            }
         }
         setText(_loc3_.findChildByName("months_required"),_controller.localization.getKey(_loc6_));
