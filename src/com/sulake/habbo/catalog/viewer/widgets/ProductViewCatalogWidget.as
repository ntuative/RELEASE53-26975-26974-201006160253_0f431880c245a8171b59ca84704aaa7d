package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_649:IItemGridWindow;
      
      private var var_87:IBitmapWrapperWindow;
      
      private var var_1283:ITextWindow;
      
      private var var_1389:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_649 != null)
         {
            var_649.visible = false;
            var_649.destroyGridItems();
         }
         if(var_1389 != null)
         {
            var_1389.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1283.text = "${" + _loc3_.name + "}";
            var_1284.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1283.text = "${" + _loc2_.localizationId + "}";
            var_1284.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_385:
                  _loc4_ = var_1388.clone();
                  if(var_649 != null)
                  {
                     var_649.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_649,var_1389,var_1319);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_248:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_258,AvatarAction.const_474);
                              _loc13_.appendAction(AvatarAction.const_399,_loc6_.productClassId);
                              _loc13_.endActionAppends();
                              _loc13_.updateAnimationByFrames(1);
                              _loc13_.updateAnimationByFrames(1);
                              _loc11_ = _loc13_.getImage(AvatarSetType.const_36,true);
      ...
      {
         var_1283 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1284 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_87 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1649 = new Point(var_87.x,var_87.y);
         var_649 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1389 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_649 == null)
         {
         ...
         var_1388 = _loc2_.content as BitmapData;
