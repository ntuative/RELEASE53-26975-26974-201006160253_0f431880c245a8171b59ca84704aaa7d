package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_884:MarketPlaceOfferData;
      
      private const const_1457:int = 1;
      
      private const const_1743:int = 40;
      
      private var var_506:IWindowContainer;
      
      private const const_1458:int = 2;
      ...
      private const const_1742:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_506)
         {
            ...
            var_506 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_506)
         {
            return;
         ...
         updateStatusDisplay(const_1458,_loc2_.length);
         if(!var_412)
         {
            var_412 = new Timer(25);
            var_412.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_885 = 0;
         populateList();
         var_412.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_602)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_506 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_506.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1457);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_413.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_412)
         {
            var_412.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_412 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_885 >= var_602.length)
            {
               return true;
            }
            addListItem(var_602.getWithIndex(var_885));
            ++var_885;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_884.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_140)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_413));
            _loc7_.selection = 0;
         }
      }
