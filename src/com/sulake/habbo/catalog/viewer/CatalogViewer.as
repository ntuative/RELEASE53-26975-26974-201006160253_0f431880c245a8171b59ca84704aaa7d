package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1565:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_418 != null)
         {
            if(var_418.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_418.window);
            var_418.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1565);
         var_418 = _loc5_;
      ...
      {
         return var_418.dispatchWidgetEvent(param1);
      }
