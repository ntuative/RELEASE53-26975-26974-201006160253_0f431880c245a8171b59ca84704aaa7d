package com.sulake.habbo.catalog.club
{
   ...
   public class ClubGiftConfirmationDialog
   {
      ...
      {
         if(!param1 || !param2 || !_controller || !var_76)
         {
            return;
         }
         ...
         {
            case "select_button":
               _controller.confirmSelection(var_76.localizationId);
               break;
      ...
      public function showConfirmation() : void
      {
         ...
         var_76.productContainer.initProductIcon(_controller.roomEngine);
      }
