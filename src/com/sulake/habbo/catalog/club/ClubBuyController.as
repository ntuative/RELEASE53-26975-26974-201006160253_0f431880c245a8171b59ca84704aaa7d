package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyController
   {
      ...
      private var var_203:ClubBuyConfirmationDialog;
      ...
      {
         closeConfirmation();
         var_203 = new ClubBuyConfirmationDialog(this,param1,param2);
      }
      ...
      public function onOffers(param1:HabboClubOffersMessageEvent) : void
      {
         ...
         var_602.sort(orderByPrecedence);
         for each(_loc6_ in var_602)
         {
