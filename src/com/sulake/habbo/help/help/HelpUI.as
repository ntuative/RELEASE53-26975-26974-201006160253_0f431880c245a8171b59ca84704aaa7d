package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_402:IWindowContainer;
      ...
      private var var_1762:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26975-26974-201006160242");
         _toolbar = param5;
         var_104 = new Map();
         var_104.add(HabboHelpViewEnum.const_1381,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_146,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_442,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_277,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_220,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_754,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_339,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_554,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_247,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_104.add(HabboHelpViewEnum.const_934,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_104.add(HabboHelpViewEnum.const_566,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_260 == HabboHelpViewEnum.const_146 || false)
         {
            return;
         }
         if(var_402 == null)
         {
            ...
            var_402 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_402 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_402 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_402 as IWindow);
      ...
      {
         return var_104.getValue(var_260);
      }
      ...
      {
         var_1761 = param1;
         var _loc2_:IHelpViewController = var_104.getValue(HabboHelpViewEnum.const_146) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_247:
               showUI(HabboHelpViewEnum.const_247);
               break;
            case CallForHelpResultEnum.const_948:
               showUI(HabboHelpViewEnum.const_934);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_260 == HabboHelpViewEnum.const_146)
         {
            return;
         }
         if(true)
         {
            ...
            var_591.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_591.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_402.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_591[1],var_591[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_591[0],var_591[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1510;
         _window.width = _loc1_.width + var_1509;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(_toolbar != null)
            {
               _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_430));
      }
