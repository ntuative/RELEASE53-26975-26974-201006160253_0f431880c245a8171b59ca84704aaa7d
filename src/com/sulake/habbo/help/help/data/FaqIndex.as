package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_770:FaqCategory;
      
      private var var_771:FaqCategory;
      ...
      {
         super();
         var_771 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_770 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_141 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_771.hasItem(param1))
         {
            var_771.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_770.hasItem(param1))
         {
            var_770.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
