package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1104:int = 0;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_740 == null || _loc3_ < 0 || _loc3_ >= var_740.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_740[_loc3_];
            main.showUI(HabboHelpViewEnum.const_554);
            main.tellUI(HabboHelpViewEnum.const_554,null);
         }
      }
   }
}
