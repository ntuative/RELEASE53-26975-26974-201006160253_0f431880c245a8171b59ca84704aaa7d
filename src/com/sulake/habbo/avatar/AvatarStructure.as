package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_430:PartSetsData;
      
      private var var_1611:PartOffsetData;
      
      private var var_926:AvatarActionManager;
      
      private var var_178:IAssetLibrary;
      
      private var var_927:IAssetLibrary;
      
      private var var_432:AvatarRenderManager;
      
      private var var_321:FigureData;
      
      private var var_628:AnimationData;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_637:String;
      
      private var var_1612:AvatarStructureDownloadSet;
      
      private var var_1356:Array;
      
      private var var_759:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_178 = param2;
         var_927 = param3;
         var_321 = new FigureData();
         var_430 = new PartSetsData();
         var_628 = new AnimationData();
         var_1612 = new AvatarStructureDownloadSet();
         var_759 = new AnimationManager();
         var_637 = param4;
         var_1611 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_926.getActionDefinitionWithState(param1);
      }
      ...
      public function init() : void
      {
         ...
         switch(var_637)
         {
            case AvatarType.const_80:
               _loc1_ = var_178.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_430.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_178.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!var_628.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_178.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_321.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_178.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_430.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_178.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!var_628.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_178.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_321.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_926.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_321.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_926.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_759.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_430.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_430.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1207[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_926.getDefaultAction();
         var _loc9_:Array = var_430.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_759.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
               for each(_loc20_ in _loc10_.getAnimatedBodyPartIds(0))
               {
                  if(_loc20_ == param1)
                  {
                     ...
                     if(_loc21_ != null)
                     {
                        for each(_loc22_ in _loc21_.method_11())
                        {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_321.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_321.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_628.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_430.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_430.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_637 + " ready to go!");
         if(var_637 == AvatarType.const_80)
         {
            var_430.getPartDefinition("ri").appendToFigure = true;
            var_430.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_80:
               if(var_178.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_178.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_178.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_178.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_80:
               if(var_178.hasAsset(_loc5_))
               {
                  var_178.removeAsset(var_178.getAssetByName(_loc5_));
               }
               var_1612.add(new AvatarStructureDownload(var_178,_loc5_,var_321));
               break;
            case AvatarType.PET:
         }
         var_1612.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_759.getAnimation(param1);
      }
      ...
      {
         var_926 = new AvatarActionManager(var_178,var_637);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1356 = var_321.getMandatorySetTypeIds();
         return var_1356;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_321.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_927.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_927.getAssetByName("dance" + _loc1_).content as XML;
            var_759.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_927.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_927.getAssetByName("fx" + _loc1_).content as XML;
            var_759.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_321.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_321.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         var_1611.loadOffsets(var_927);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_926.sortActions(param1);
      }
   }
}
