package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_880:IAvatarImage;
      ...
      {
         if(var_630 == param1 || var_630 == GeometryType.const_976 && param1 == GeometryType.const_937 || param1 == GeometryType.const_976 && var_630 == GeometryType.const_937)
         {
            var_630 = param1;
            return;
         }
      ...
      public function getAnimationDataInFrame(param1:String, param2:int) : AnimationLayerData
      {
         ...
         return var_80.getBodyPartData(_loc4_.definition.state + "." + _loc4_.actionParameter,param2,param1);
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc17_ = var_80.getAnimation(_loc5_.definition.state + "." + _loc5_.actionParameter);
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_694)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_375)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
               }
               _loc13_ = _loc17_.method_10;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_80.getParts(param1,var_880.getFigure(),_loc6_,var_630,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_80.getCanvas(var_152,var_630);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc24_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1385[param1])
            {
            ...
            _loc9_ = var_152 + "_" + _loc15_.assetPartDefinition + "_" + _loc10_ + "_" + _loc11_ + "_" + _loc19_ + "_" + _loc12_;
            _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            if(_loc14_ == null)
            {
               _loc9_ = var_152 + "_std_" + _loc10_ + "_" + _loc11_ + "_" + _loc19_ + "_0";
               _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            }
            if(!(!_loc14_ || !_loc14_.content))
            {
               ...
               {
                  _loc33_ = var_80.renderManager.paletteManager.getPalette(_loc7_.paletteMapId);
               ...
               if((_loc30_ == AvatarAction.const_967 || _loc30_ == AvatarAction.const_465) && (_loc6_ == AvatarBodyPartType.const_209 || _loc6_ == AvatarBodyPartType.const_1304 || _loc6_ == AvatarBodyPartType.const_1308) && _loc7_.color != null)
               {
               ...
               if(_loc18_)
               {
                  if(var_152 == AvatarScaleType.const_53)
                  {
                     _loc31_.x += 65;
                  }
                  else
      ...
      public function setAction(param1:IActiveActionData) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Array = var_80.getActiveBodyPartIds(param1);
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = var_80.getBodyPartsUnordered(param1);
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         ...
         if(var_136 != null)
         {
            ...
            {
               _loc5_ = var_136.getValue(_loc4_) as AvatarImageBodyPartCache;
               if(_loc5_ != null)
               {
