package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1581:Number = 1.0;
      
      private var _b:uint;
      
      private var var_1582:Number = 1.0;
      ...
      private var var_1583:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1583,var_1582,var_1581,_alphaMultiplier);
         var_1032 = generatePaletteMapForGrayscale(var_1831,var_1830);
      }
      
      public function get reds() : Array
      {
         return var_1032.getValue("reds") as Array;
      }
      ...
      {
         return var_1032.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1032.getValue("greens") as Array;
      }
      ...
      {
         return var_1032.getValue("alphas") as Array;
      }
