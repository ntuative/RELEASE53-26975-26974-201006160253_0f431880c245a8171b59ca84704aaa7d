package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_1751:int = 2;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_773 >= 0 && var_180.length > var_773)
         {
            _loc2_ = var_180[var_773];
            if(_loc2_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         while(_loc5_ < var_207.length)
         {
            ...
            {
               if(_loc7_.length > var_207[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_207[param2],param2);
         var_207[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_207[param1])
         {
            return null;
         }
      ...
      {
         return var_180[var_773] as AvatarEditorGridPartItem;
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_207 = new Array(param1.length);
         var _loc3_:int = 0;
