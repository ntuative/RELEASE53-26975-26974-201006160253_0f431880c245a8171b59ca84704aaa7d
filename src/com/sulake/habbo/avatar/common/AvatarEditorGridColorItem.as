package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_817:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_726.width,var_726.height,true,0);
            _loc1_.bitmap.copyPixels(var_726,var_726.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_986.width,var_986.height,true,0);
            _loc5_ = var_986.clone();
            _loc5_.colorTransform(_loc5_.rect,var_817.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_818.width,var_818.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_818,var_818.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
