package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1043:int = -1.0E9;
      
      private var var_1248:Boolean = true;
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_904,_loc3_.status);
         }
      }
      ...
      private function onRoomVisualizationSettings(param1:IMessageEvent) : void
      {
         ...
         if(var_10 != null)
         {
            var_10.updateObjectRoomVisibilities(_loc4_,_loc5_,_loc6_,true);
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_655);
         var _loc8_:int = 0;
      ...
      private function onRoomProperty(param1:IMessageEvent) : void
      {
         ...
         if(var_10 != null)
         {
            var_10.updateObjectRoom(_loc4_,_loc5_,_loc6_,_loc7_,_loc8_);
         }
      }
      ...
      private function addActiveObject(param1:int, param2:int, param3:ObjectMessageData) : void
      {
         ...
         {
            var_10.addObjectFurniture(param1,param2,param3.id,param3.type,_loc4_,_loc5_,param3.state,param3.data,param3.extra,param3.method_2);
         }
      }
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_933:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_844:
                     _loc10_ = "std";
               }
