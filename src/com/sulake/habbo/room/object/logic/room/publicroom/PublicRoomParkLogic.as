package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1135:String = "bus_oviopen_hidden";
      
      private static const const_1137:String = "goawaybus";
      
      private static const const_1136:String = "bus";
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  case const_1137:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_512,0,_loc4_,_loc5_);
                     break;
                  case const_1136:
                  case const_1135:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_409,0,_loc4_,_loc5_);
               }
         }
