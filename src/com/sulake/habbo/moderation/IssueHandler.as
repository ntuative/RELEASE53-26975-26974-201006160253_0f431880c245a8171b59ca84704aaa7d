package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_462:UserInfoCtrl;
      
      private var var_61:ModerationManager;
      
      private var var_1163:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.releaseBundle(var_120.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_462 = new UserInfoCtrl(_window,var_61,_loc3_.message);
         var_1163 = new UserInfoCtrl(_window,var_61,_loc3_.message);
         var_462.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_120.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1163.load(_loc4_,var_120.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.closeBundle(var_120.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_61.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_61,WindowTracker.const_916,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_61 != null && false && var_120 != null)
         {
            var_61.issueManager.removeHandler(var_120.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_462 = new UserInfoCtrl(_window,var_61,_loc3_.message);
            var_462.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.closeBundle(var_120.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.closeBundle(var_120.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         return WindowTracker.const_1335;
      }
   }
}
