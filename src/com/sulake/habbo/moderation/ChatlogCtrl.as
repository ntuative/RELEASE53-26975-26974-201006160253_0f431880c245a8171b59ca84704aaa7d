package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1663:IMessageComposer;
      ...
      private var var_872:IWindowContainer;
      
      private var var_873:IWindowContainer;
      
      private var var_52:IFrameWindow;
      
      private var var_1290:Dictionary;
      ...
      {
         var_872 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_873 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         _main.connection.send(var_1663);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_872.clone());
      ...
      {
         if(param1.type != WindowEvent.const_47 || param2 != var_52)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_873.clone());
         _loc4_.color = var_1290[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
