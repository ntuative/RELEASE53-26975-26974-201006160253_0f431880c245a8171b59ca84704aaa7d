package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_764:OffenceCategoryData;
      
      private var var_438:ITextFieldWindow;
      
      private var var_940:IButtonWindow;
      ...
      private var var_939:IDropMenuWindow;
      
      private var var_52:IFrameWindow;
      
      private var var_763:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_941 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_940 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_939.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1367,var_438.text,getBanLength(),var_1366));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_939.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1367,var_438.text,var_1366));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_764 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1367,var_438.text,var_1366));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = var_764 != null;
         if(this.var_763 != null)
         {
            var_52.findChildByName("offence_txt").caption = this.var_763.name;
            var_52.findChildByName("offence_category").visible = true;
         }
         else if(this.var_764 != null)
         {
            this.refreshButtons("offences_cont",2,var_764.offences,var_941,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_940,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_763 = var_764.offences[_loc3_];
         var_438.text = var_763.msg;
         var_310 = false;
         this.refreshCategorization();
      }
      ...
      public function show() : void
      {
         ...
         var_52.caption = "Mod action on: " + var_1556;
         ...
         var_939 = IDropMenuWindow(var_52.findChildByName("banLengthSelect"));
         prepareBanSelect(var_939);
