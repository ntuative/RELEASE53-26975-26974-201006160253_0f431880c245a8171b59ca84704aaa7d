package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1335:int = 8;
      
      public static const const_855:int = 5;
      
      public static const const_1269:int = 1;
      
      public static const const_1203:int = 2;
      ...
      {
         var_1588 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1588[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1588[param1] = _loc2_;
         }
         return _loc2_;
      }
