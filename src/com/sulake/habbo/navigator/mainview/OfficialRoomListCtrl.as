package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_2343:PublicRoomThumbs;
      
      private var var_20:IWindowContainer;
      
      private var _navigator:HabboNavigator;
      
      private var var_934:UserCountRenderer;
      
      private var var_49:IItemListWindow;
      
      public function OfficialRoomListCtrl(param1:HabboNavigator)
      {
         var_2343 = new PublicRoomThumbs();
         super();
         _navigator = param1;
         var_934 = new UserCountRenderer(_navigator);
      }
      ...
      {
         var _loc4_:String = var_2343.resolveRoomImageName(param2);
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:OfficialRoomEntryData) : Boolean
      {
         ...
         if(param1)
         {
            ...
            if(param3.type == OfficialRoomEntryData.const_1291)
            {
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_535 || param2.type == OfficialRoomEntryData.const_590))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
            var_934.refreshUserCount(param2.maxUsers,param1,param2.userCount,"${navigator.usercounttooltip.users}",param1.width - _loc3_ - _loc4_,param1.height - _loc3_ - _loc5_);
         }
      }
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_218,Tabs.const_304,_loc2_.tag);
         }
