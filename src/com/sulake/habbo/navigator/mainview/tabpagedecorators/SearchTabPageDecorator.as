package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1629:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_218,Tabs.const_205,"-1",MainViewCtrl.const_750);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1629 == null)
         {
            ...
            var_1629 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1629.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
