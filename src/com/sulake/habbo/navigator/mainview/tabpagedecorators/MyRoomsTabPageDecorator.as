package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_548:IDropMenuWindow;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 3)
         {
            return Tabs.const_625;
         }
         if(param1 == 4)
         {
            return Tabs.const_711;
         }
      ...
      {
         var _loc1_:int = var_548 == null ? 0 : int(var_548.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_251,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_548 == null)
         {
            var_548 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_548.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
