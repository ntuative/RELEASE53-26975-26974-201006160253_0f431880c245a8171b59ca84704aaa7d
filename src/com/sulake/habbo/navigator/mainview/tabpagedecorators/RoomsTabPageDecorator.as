package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_532:IDropMenuWindow;
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = var_532 == null ? 0 : int(var_532.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_297,Tabs.const_356);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_297,Tabs.const_673);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_297,Tabs.const_356,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_532 == null)
         {
            var_532 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_532.procedure = onChangeFilter;
