package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2360:IButtonWindow;
      ...
      private var var_2361:ITextWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_821.getText();
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_2361.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_821.setText(param1.eventDescription);
         var_992.setText(getTagFromEvent(param1,1));
         var_991.setText(getTagFromEvent(param1,2));
         var_1461.visible = false;
         var_1460.visible = true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_2361 = ITextWindow(find("event_type_disabled_text"));
            var_1698 = ITextWindow(find("create_caption"));
            var_1700 = ITextWindow(find("edit_caption"));
            var_1461 = IButtonWindow(find("create_button"));
            var_1460 = IButtonWindow(find("edit_button"));
            var_2360 = IButtonWindow(find("cancel_button"));
            var_1459 = IButtonWindow(find("end_button"));
            var_993 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1461,onCreateButtonClick);
            Util.setProcDirectly(var_1460,onEditButtonClick);
            Util.setProcDirectly(var_1459,onEndButtonClick);
            Util.setProcDirectly(var_2360,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_821 = new TextFieldManager(_navigator,getInput("event_desc"),100);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_821.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function createEvent() : void
      {
         ...
         var_1461.visible = true;
         var_1460.visible = false;
