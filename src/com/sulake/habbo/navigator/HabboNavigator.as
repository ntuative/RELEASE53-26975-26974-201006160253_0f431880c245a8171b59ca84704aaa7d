package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_849:RoomCreateViewCtrl;
      ...
      private var var_485:RoomInfoViewCtrl;
      ...
      private var var_1109:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_263 = new MainViewCtrl(this);
         var_485 = new RoomInfoViewCtrl(this);
         var_849 = new RoomCreateViewCtrl(this);
         var_1731 = new RoomThumbnailRenderer(this);
         var_1109 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_429 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_263.startSearch(Tabs.const_218,Tabs.const_304,param1);
         var_263.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(_toolbar != null)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               _toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      {
         var_485.userDefinedRoomEventsCtrl.stuffSelected(param1,param2);
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_263.startSearch(Tabs.const_251,Tabs.const_227);
         var_429.getTab(Tabs.const_251).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_263.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
