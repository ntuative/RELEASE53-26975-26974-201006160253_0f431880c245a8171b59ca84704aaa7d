package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_36:String = "RSE_CREATED";
      
      private var var_1177:UserDataManager;
      ...
      {
         if(var_36 == RoomSessionEvent.const_348 && _connection != null)
         {
            var_36 = RoomSessionEvent.const_95;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1177 as IUserDataManager;
      }
