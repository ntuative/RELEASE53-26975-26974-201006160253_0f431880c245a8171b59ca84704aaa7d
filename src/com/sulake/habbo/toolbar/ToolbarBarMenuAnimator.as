package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1096:Number = 90;
      
      private static const const_780:int = 50;
      
      private static const const_1075:Number = 25;
      
      private static const const_1076:int = 50;
      
      private static const const_194:Boolean = true;
       
      
      private var var_601:Timer;
      
      private var var_1040:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1040 = param2;
         var_601 = new Timer(const_1075);
         var_601.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function getWindowByName(param1:String) : IWindow
      {
         ...
         if(_loc2_ == null)
         {
            _loc3_ = _windowManager.method_6(0);
            if(_loc3_ != null)
            {
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_487.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_487.splice(_loc3_,1);
            var_488.splice(_loc3_,1);
         }
         var_488.push(param1.name);
         var_487.push(param2);
         param1.addEventListener(WindowEvent.const_493,windowEventListener);
         param1.addEventListener(WindowEvent.const_225,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_487[var_488.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1040.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1040.getIconLoc(param1.iconId);
      ...
      {
         return var_488[var_487.indexOf(param1)];
      }
      ...
      {
         return param1.x + param1.width < const_780 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_780 || param1.desktop.height - param1.y < const_1076;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_488.length)
         {
            if(var_488[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
