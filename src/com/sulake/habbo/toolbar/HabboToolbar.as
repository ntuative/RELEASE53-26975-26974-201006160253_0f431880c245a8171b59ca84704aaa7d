package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_996,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_192,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_171,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_49,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_511,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_707,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_886,onHideWindowEvent);
         var_36 = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_92));
      }
