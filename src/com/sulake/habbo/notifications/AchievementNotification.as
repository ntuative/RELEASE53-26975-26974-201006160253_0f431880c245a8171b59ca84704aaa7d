package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1794 = param2;
         var_381 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_139,onBadgeImageReady);
         ...
         var_206 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_2047 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_206);
      ...
      public function dispose() : void
      {
         if(var_381 != null)
         {
            var_381.events.removeEventListener(BadgeImageReadyEvent.const_139,onBadgeImageReady);
            var_381 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_752,var_2047);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_752,var_752));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_752,var_752));
         _localizations.registerParameter(param1,"level",var_1794.toString());
         _localizations.registerParameter(param1,"name",var_381.userName);
         _localizations.registerParameter(param1,"realname",var_381.realName);
      }
   }
}
