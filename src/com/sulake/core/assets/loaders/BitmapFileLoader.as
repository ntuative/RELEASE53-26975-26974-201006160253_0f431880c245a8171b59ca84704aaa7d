package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         var_684 = param2 == null ? "" : param2.url;
         _type = param1;
         var_14 = new Loader();
         var_1015 = new LoaderContext();
         var_1015.checkPolicyFile = true;
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_393 < var_2482)
            {
               ...
               var_14.load(new URLRequest(var_684 + (var_684.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_393),var_1015);
               return true;
            }
         }
         return false;
