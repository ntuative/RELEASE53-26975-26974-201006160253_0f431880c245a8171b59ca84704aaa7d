package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_939:uint = 4;
      
      public static const COMPONENT_EVENT_ERROR:String = "COMPONENT_EVENT_ERROR";
      
      public static const const_1646:uint = 1;
      ...
      protected var var_1189:uint;
      
      protected var _isDisposed:Boolean = false;
      
      protected var var_1009:String = "";
      
      protected var var_2420:String = "";
      
      protected var _assets:IAssetLibrary;
      
      protected var var_441:uint = 0;
      
      protected var var_2483:String = "";
      
      protected var var_16:IContext = null;
      
      protected var var_2306:Boolean = false;
      
      protected var _events:EventDispatcher;
      
      protected var var_192:InterfaceStructList;
      
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super();
         var_1189 = param2;
         var_192 = new InterfaceStructList();
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_192.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            var_1009 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_1009);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1189 & const_939)
         {
            if(_loc3_ == 0)
            {
               if(var_192.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_192.getStructByIndex(_loc8_);
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_441 + "]";
      }
