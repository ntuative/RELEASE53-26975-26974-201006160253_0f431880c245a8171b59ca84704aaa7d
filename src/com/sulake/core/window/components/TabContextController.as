package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1093:String = "content";
      
      private static const const_1092:String = "selector";
       
      
      private var var_1223:Boolean = false;
      
      protected var var_1012:ITabSelectorWindow;
      
      private var var_947:Boolean = false;
      
      protected var var_1711:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1711 == null)
         {
            var_1711 = findChildByTag(TabContextController.const_1093) as IWindowContainer;
         }
         return var_1711;
      }
      ...
      {
         return var_1012.numSelectables;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_1012 == null)
         {
            var_1012 = findChildByTag(TabContextController.const_1092) as ITabSelectorWindow;
            if(var_1012 != null)
            {
               var_1012.procedure = selectorEventProc;
            }
         }
         return var_1012;
      }
      ...
      {
         return !!var_947 ? selector.iterator : null;
      }
