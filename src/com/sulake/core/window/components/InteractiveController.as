package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1061:String = "tool_tip_caption";
      
      protected static const const_1448:uint = 500;
      ...
      protected var var_2418:uint = 0;
      
      protected var var_1017:String = "";
      
      protected var var_476:Array;
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_476 = new Array();
         var_476[0] = MouseCursorType.ARROW_LINK;
         var_476[1] = MouseCursorType.const_42;
         var_476[2] = MouseCursorType.ARROW_LINK;
         var_476[3] = MouseCursorType.ARROW_LINK;
         var_476[4] = MouseCursorType.const_42;
         var_476[5] = MouseCursorType.const_42;
         var_476[6] = MouseCursorType.ARROW_LINK;
         if(var_344 == null)
         {
            var_344 = new Array();
            var_344[0] = WindowState.const_98;
            ...
            var_344[5] = WindowState.const_97;
            var_344[6] = WindowState.const_72;
         }
      ...
      {
         param2.push(new PropertyStruct(const_1061,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_769));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_923,param1.toolTipDelay != const_1448));
         return param2;
      }
      ...
      {
         var_1017 = param1 == null ? const_769 : param1;
      }
