package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2484:Rectangle = new Rectangle();
       
      
      protected var var_221:Boolean;
      
      protected var var_69:TextMargins;
      
      protected var var_582:String = "none";
      
      protected var var_685:Number;
      ...
      {
         return new Rectangle(var_685 * maxScrollH,var_394 * maxScrollV,width,height);
      }
      ...
      {
         var_685 = param1;
         _field.scrollH = var_685 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_923,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_476,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_476,true));
         ...
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_67,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_720,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_720,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("margin_left",var_69.left,PropertyStruct.const_67,true));
         _loc1_.push(new PropertyStruct("margin_top",var_69.top,PropertyStruct.const_67,true));
         _loc1_.push(new PropertyStruct("margin_right",var_69.right,PropertyStruct.const_67,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_69.bottom,PropertyStruct.const_67,true));
         _loc1_.push(new PropertyStruct("auto_size",var_582,PropertyStruct.STRING,var_582 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_720,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_582 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_582 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_582 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_582 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
