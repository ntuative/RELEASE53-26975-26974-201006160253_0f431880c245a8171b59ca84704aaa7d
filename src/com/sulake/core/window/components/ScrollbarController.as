package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1067:String = "increment";
      
      private static const const_516:String = "slider_bar";
      
      private static const const_1066:String = "decrement";
      
      private static const const_775:String = "slider_track";
      ...
      protected var var_826:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_170 = false;
         var_21 = param12;
         _horizontal = param2 == WindowType.const_405;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_516:
         ...
         if(param2.type == WindowNotifyEvent.const_467)
         {
            if(var_21 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(ScrollbarController.const_775) as WindowController;
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_516) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_832 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_832 != null)
         {
            _loc1_ = findParentByName(var_832) as IScrollableWindow;
            if(_loc1_ == null && var_9 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_9).findChildByName(var_832) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1067)
            {
               if(var_21)
               {
                  var_590 = true;
            ...
            else if(param2.name == ScrollbarController.const_1066)
            {
               if(var_21)
               {
                  var_590 = true;
            ...
            else if(param2.name == ScrollbarController.const_775)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_516).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_1038)
         {
