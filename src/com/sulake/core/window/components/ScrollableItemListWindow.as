package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_878:IItemListWindow;
      
      private var var_360:IScrollbarWindow;
      
      private var var_1561:Boolean = true;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_scrollBar.testStateFlag(WindowState.const_72))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_360)
         {
            var_360 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_360)
            {
               var_360.addEventListener(WindowEvent.const_267,scrollBarEventProc);
               var_360.addEventListener(WindowEvent.const_225,scrollBarEventProc);
            }
         }
         return var_360;
      }
      ...
      override public function dispose() : void
      {
         if(var_360)
         {
            var_360.removeEventListener(WindowEvent.const_267,scrollBarEventProc);
            var_360.removeEventListener(WindowEvent.const_225,scrollBarEventProc);
            var_360 = null;
         }
         if(var_878)
         {
      ...
      {
         if(param1.type == WindowEvent.const_267)
         {
            showScrollBar();
         }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_878)
         {
            var_878 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_878;
      }
