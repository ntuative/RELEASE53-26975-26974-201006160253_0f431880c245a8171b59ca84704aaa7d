package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1585:String = "_INCLUDE";
      
      public static const ELEMENT_TAG_EXCLUDE:String = "_EXCLUDE";
      
      public static const const_1690:String = "_TEMP";
      ...
      protected var var_1198:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_1018:Dictionary;
      
      protected var var_1485:Map;
      
      protected var var_16:IWindowContext;
      
      protected var var_1484:Dictionary;
      
      protected var var_1197:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1198 = new Dictionary();
         TypeCodeTable.fillTables(var_1197,var_1198);
         var_1018 = new Dictionary();
         var_1484 = new Dictionary();
         ParamCodeTable.fillTables(var_1018,var_1484);
         var_1485 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1166,"");
         return param1.replace(const_1167,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1197)
            {
               delete var_1197[_loc1_];
            }
            for(_loc1_ in var_1198)
            {
               delete var_1198[_loc1_];
            }
            for(_loc1_ in var_1018)
            {
               delete var_1018[_loc1_];
            }
            for(_loc1_ in var_1484)
            {
               delete var_1484[_loc1_];
            }
            var_1485.dispose();
            var_1485 = null;
            var_16 = null;
