package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_974:uint = 256;
      
      protected static var var_689:uint = 0;
      
      protected static var var_395:uint = 0;
      
      public static const const_1009:uint = 2;
      
      public static const const_1680:uint = 128;
      
      public static const const_1629:uint = 64;
      
      public static const const_634:uint = 4;
      
      public static const const_1367:uint = 0;
      
      public static const const_1201:uint = 16;
      
      public static const const_723:uint = 1;
      
      public static const const_1229:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_681:Boolean;
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_681)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_395 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
         ...
         if(var_681)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_395 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1709,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1709,16777215);
                  }
                  var_395 += bitmap.width * bitmap.height * 4;
               }
