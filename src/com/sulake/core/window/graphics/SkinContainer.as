package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_786:uint = 8;
       
      
      private var var_1909:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1549 = new Dictionary();
         var_1908 = new Dictionary();
         TypeCodeTable.fillTables(var_1549,var_1908);
         var_1279 = new Dictionary();
         var_1909 = new Dictionary();
         StateCodeTable.fillTables(var_1279,var_1909);
         var_500 = new Dictionary();
         var_500["skin"] = BitmapSkinRenderer;
         var_500["bitmap"] = BitmapDataRenderer;
         var_500["fill"] = FillSkinRenderer;
         var_500["text"] = TextSkinRenderer;
         var_500["shape"] = ShapeSkinRenderer;
         var_500["unknown"] = SkinRenderer;
         var_500["null"] = NullSkinRenderer;
         if(var_396 == null)
         {
            var_396 = new Array();
            var_396.push(WindowState.const_64);
            var_396.push(WindowState.const_72);
            var_396.push(WindowState.const_97);
            var_396.push(WindowState.WINDOW_STATE_SELECTED);
            var_396.push(WindowState.const_82);
            var_396.push(WindowState.const_77);
            var_396.push(WindowState.const_98);
            var_396.push(WindowState.const_88);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1279)
         {
            _loc3_.push(var_1279[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1549[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_723[param1];
      ...
      {
         var _loc3_:Array = var_722[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_722[param1] = new Array(SkinContainer.const_786);
         }
         var_722[param1][param2] = param3;
         if(true)
         {
            var_723[param1] = new Array(SkinContainer.const_786);
         }
         var_723[param1][param2] = param4;
      }
